...
(Photon setze einen Spawnpunkt im Multiplayer voraus, was wir hiermit umgehen konnten).
...
an. Zu den Übertragungsmethoden, die wir verwendet haben, zählen: Events, RPCs und Streams, die alle in jeweils
...
Waffe implementieren mussten (primary und secondary attack z. B.). So haben wir sechs verschiedene Waffen zur Verfügung
gestellt.
